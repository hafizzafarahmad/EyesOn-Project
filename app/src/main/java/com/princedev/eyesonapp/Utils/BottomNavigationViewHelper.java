...
import com.princedev.eyesonapp.PostActivity;
import com.princedev.eyesonapp.ProfileActivity;
import com.princedev.eyesonapp.R;
import com.princedev.eyesonapp.SearchActivity;

/**
 * Created by Fizz on 26/10/2017.
 */
        ...
        view.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.ic_alert:
                        Intent intent4 = new Intent(context, FriendsActivity.class);//ACTIVITY_NUM = 3
